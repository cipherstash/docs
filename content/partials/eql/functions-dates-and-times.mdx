...
<EqlFn name="eql_v3.eq(a, b)" ops="=" domains="date_eq,date_ord,date_ord_ope,date_ord_ore,timestamp_eq,timestamp_ord,timestamp_ord_ope,timestamp_ord_ore">
...
<EqlFn name="eql_v3.neq(a, b)" ops="<>" domains="date_eq,date_ord,date_ord_ope,date_ord_ore,timestamp_eq,timestamp_ord,timestamp_ord_ope,timestamp_ord_ore">
...
<EqlFn name="eql_v3.lt / lte / gt / gte" ops="<,<=,>,>=" grouped domains="date_ord,date_ord_ope,date_ord_ore,timestamp_ord,timestamp_ord_ope,timestamp_ord_ore">
...
<EqlFn name="eql_v3.min(col)" ops="MIN" agg domains="date_ord,date_ord_ope,date_ord_ore,timestamp_ord,timestamp_ord_ope,timestamp_ord_ore">
...
<EqlFn name="eql_v3.max(col)" ops="MAX" agg domains="date_ord,date_ord_ope,date_ord_ore,timestamp_ord,timestamp_ord_ope,timestamp_ord_ore">
