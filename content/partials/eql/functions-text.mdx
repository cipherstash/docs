...
<EqlFn id="fn-eq" name="eql_v3.eq(a, b)" ops="=" domains="text_eq,text_ord,text_ord_ope,text_ord_ore,text_search,text_search_ore">
...
<EqlFn id="fn-neq" name="eql_v3.neq(a, b)" ops="<>" domains="text_eq,text_ord,text_ord_ope,text_ord_ore,text_search,text_search_ore">
...
<EqlFn id="fn-comparison" name="eql_v3.lt / lte / gt / gte" ops="<,<=,>,>=" domains="text_ord,text_ord_ope,text_ord_ore,text_search,text_search_ore">
...
<EqlFn id="fn-contains" name="eql_v3.contains(a, b)" ops="@>" domains="text_match,text_search,text_search_ore">
...
<EqlFn id="fn-contained_by" name="eql_v3.contained_by(a, b)" ops="<@" domains="text_match,text_search,text_search_ore">
...
<EqlFn id="fn-min" name="eql_v3.min(col)" ops="MIN" agg domains="text_ord,text_ord_ope,text_ord_ore,text_search,text_search_ore">
...
<EqlFn id="fn-max" name="eql_v3.max(col)" ops="MAX" agg domains="text_ord,text_ord_ope,text_ord_ore,text_search,text_search_ore">
