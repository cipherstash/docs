...
| Error | Cause | Fix |
|---|---|---|
| `Could not find stash.config.ts` | No config file in cwd or parent dirs | Run `npx @cipherstash/cli db setup` to generate it, or create `stash.config.ts` manually |
