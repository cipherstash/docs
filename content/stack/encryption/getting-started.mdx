...
- [PostgreSQL](https://www.postgresql.org/) (optional — needed if you want to store encrypted data in Step 7)
...
<Callout type="info">
  For searchable encryption in PostgreSQL, install the [EQL extension](https://github.com/cipherstash/encrypt-query-language) and use the `eql_v2_encrypted` column type instead. See [Searchable encryption](/stack/encryption/searchable-encryption) for details.
</Callout>
