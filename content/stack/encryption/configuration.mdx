...
Set these in a `.env` file or your hosting platform:
...
Sign up at [cipherstash.com/signup](https://dashboard.cipherstash.com/sign-up) and follow the onboarding to generate credentials.

## Programmatic config

Pass config directly when initializing the client. Use this approach when loading credentials from a secret manager:
