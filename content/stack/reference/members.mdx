...
This creates a unique [device](/stack/reference/glossary#device) and [client](/stack/reference/glossary#client) for that developer, with automatic access to the default [keyset](/stack/cipherstash/kms/keysets).
