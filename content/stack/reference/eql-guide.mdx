...
description: Learn how EQL adds PostgreSQL types, operators, and functions for querying encrypted data, covering the eql_v2_encrypted type and searchable index types.
---
