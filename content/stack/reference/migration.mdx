...
description: Migrate from @cipherstash/protect to @cipherstash/stack with mapped imports, renamed functions, and updated schema definitions in a few simple steps.
---
