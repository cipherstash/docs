---
title: API Reference
description: Browse the CipherStash API reference, including the @cipherstash/stack SDK with Encryption and Secrets, plus the EQL types, operators, and functions.
---
