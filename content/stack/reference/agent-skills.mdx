...
The CipherStash CLI (`@cipherstash/cli`) for database setup, schema management, and project initialization.
...
4. **Wire up encryption automatically:** Run `npx @cipherstash/wizard` to let the AI edit your schema and call sites. Or ask your coding agent to wire up `encryptModel`/`decryptModel` directly using the installed skills.
