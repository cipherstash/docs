...
1. **Initialize your project:** Ask your agent to set up CipherStash and it will run `npx stash init`.
...
3. **Set up the database:** The agent will guide you through `npx stash db install`. The CLI auto-detects Supabase and Drizzle from your project.
