...
**Related docs:** [Encryption](/stack/encryption)
...
- Database commands: `db setup`, `db install`, `db upgrade`, `db push`, `db validate`, `db status`, `db test-connection`
...
- Secrets management via `secrets` subcommands
...
**Related docs:** [CipherStash Forge](/stack/encryption/forge)
...
**Related docs:** [Drizzle integration](/stack/encryption/drizzle)
...
**Related docs:** [Supabase integration](/stack/encryption/supabase)
...
**Related docs:** [DynamoDB integration](/stack/encryption/dynamodb)
...
- CLI commands: `secrets set`, `secrets get`, `secrets get-many`, `secrets list`, `secrets delete`
...
**Related docs:** [Secrets](/stack/secrets)
...
3. **Set up the database:** The agent will guide you through `npx @cipherstash/cli db setup` with the right flags for your provider.
