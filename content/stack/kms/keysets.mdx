...
When a developer runs `npx @cipherstash/cli init`, their device-backed client is automatically granted access to the default keyset. This means no additional configuration is needed for local development.
