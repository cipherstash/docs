...
If you want to bring your own [IDP](/stack/platform/glossary#idp-identity-provider) to CTS, you can configure your workspace to use either [Auth0](https://auth0.com/), [Okta](https://okta.com/), or [Clerk](https://clerk.com/).
