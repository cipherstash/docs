...
description: Run CipherStash Proxy locally with Docker and set up credentials, then insert, query, and search transparently encrypted PostgreSQL data in minutes.
---
...
- All data remains searchable, protected with non-deterministic AES-256-GCM-SIV encryption
