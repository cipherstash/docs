...
<Callout type="info">
Complete the [Getting started](/stack/quickstart) guide first to initialize CipherStash on your machine.
</Callout>
...
For production Proxy deployments, see [Going to production](/stack/deploy/going-to-production) to set up machine client credentials.
