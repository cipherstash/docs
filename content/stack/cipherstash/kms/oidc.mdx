...
This pairs with [identity-aware encryption](/reference/stack/api-reference) via `LockContext`, which binds encryption operations to a specific user identity.
...
See the [Stack API reference](/reference/stack/api-reference) for the full `LockContext` API.
