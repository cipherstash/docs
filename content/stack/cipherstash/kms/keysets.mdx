...
When a developer runs `npx stash init`, their device-backed client is automatically granted access to the default keyset. This means no additional configuration is needed for local development.
