---
title: Keysets
description: Use CipherStash keysets with ZeroKMS to derive unique data keys and cryptographically isolate tenants, environments, and custom boundaries in your app.
---
...
When you specify a keyset, every key seed ZeroKMS returns is scoped to that keyset's authority key, so the data keys your application derives are scoped to it too.
This means:
