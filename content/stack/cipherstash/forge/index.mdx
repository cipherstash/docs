...
<Cards>
  <Card title="Init wizard" href="/stack/cipherstash/forge/init" description="Use the interactive wizard to set up Forge in your project." />
  <Card title="Install and upgrade" href="/stack/cipherstash/forge/install" description="Install or upgrade EQL in your database." />
  <Card title="Schema validation" href="/stack/cipherstash/forge/validate" description="Validate your encryption schema for common misconfigurations." />
  <Card title="Push to database" href="/stack/cipherstash/forge/push" description="Push your encryption schema to the database for use with CipherStash Proxy." />
  <Card title="Programmatic API" href="/stack/cipherstash/forge/api" description="Use Forge as a library in your own scripts and tooling." />
</Cards>
