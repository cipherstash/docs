...
Use [CipherStash Forge](/stack/cipherstash/forge) to generate a Drizzle migration that installs the [EQL](/stack/reference/eql-guide) extension:
...
See [CipherStash Forge — Drizzle migrations](/stack/cipherstash/forge/install#drizzle-migrations) for details.
