---
title: Configuration
description: Configure the @cipherstash/stack encryption SDK with environment variables or programmatic config, covering credentials, keysets, logging, and bundlers.
---
