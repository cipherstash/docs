...
<Callout type="info">
  Install [EQL](/stack/reference/eql-guide) in your Supabase database using the [CipherStash CLI](/stack/cipherstash/cli) so encrypted columns can use the `eql_v2_encrypted` type.
</Callout>
