...
<Cards>
  <Card title="Get started with the CLI" href="/reference/cli" description="Install EQL, validate schemas, and manage your database setup." />
  <Card title="Interactive setup" href="/reference/cli/init" description="Set up the CLI in your project with the interactive init command." />
</Cards>
