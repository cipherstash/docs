...
`init` generates your encryption schema, client file, and installs `@cipherstash/cli` as a devDependency. Then run `npx @cipherstash/cli db install` to configure your database.
