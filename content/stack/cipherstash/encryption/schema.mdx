...
description: Define a @cipherstash/stack schema with encryptedTable and encryptedColumn to choose columns to encrypt, index types, data types, and nested fields.
---
