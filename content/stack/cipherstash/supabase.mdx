...
The CLI auto-detects Supabase from your `DATABASE_URL` host and uses the Supabase-compatible install automatically. This installs the EQL extension with Supabase-compatible permissions and configures searchable encryption for your database. You can also pass `--supabase` explicitly if needed.
