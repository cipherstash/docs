...
Auto-detects your Postgres provider and installs the EQL extension for searchable encryption.
...
**Want to manage secrets?** [Secrets](/stack/cipherstash/secrets) gives you end-to-end encrypted config without .env files.
