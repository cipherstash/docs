...
You need CipherStash credentials for your production Proxy deployment. Create a machine client and access key in the Dashboard — see [Going to production](/stack/deploy/going-to-production) for the full guide.
