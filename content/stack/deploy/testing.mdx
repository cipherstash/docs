---
title: Testing
description: Test applications using @cipherstash/stack encryption with a dedicated workspace or mocked client, plus PostgreSQL integration tests and CI setup.
---
