---
title: SST
description: Configure SST serverless functions for @cipherstash/stack by excluding it from esbuild bundling and installing it into the Lambda deployment artifact.
---
