...
description: Diagnose @cipherstash/stack issues including client init failures, decryption and keyset errors, empty search results, native addon loading, and performance.
---
...
If the stored ciphertext has been modified, decryption fails. AES-256-GCM-SIV provides authenticated encryption, which detects tampering.
