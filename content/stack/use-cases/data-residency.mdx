...
ZeroKMS is available in [multiple regions](/stack/kms/regions) globally:
...
```typescript title="regional-access.ts"
...
| **Ability to revoke access** | Delete client credentials or revoke [Lock Context](/stack/encryption/identity) identities |
| **Cryptographic enforcement** | Dual-party key split makes unauthorized access mathematically impossible |

## Next steps

- [Configure ZeroKMS regions](/stack/kms/regions) for your workspaces
- [Set up identity-aware encryption](/stack/encryption/identity) for access control
- [Review disaster recovery](/stack/kms/disaster-recovery) for multi-region key backup
