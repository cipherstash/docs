...
- [Encryption SDK](/docs/encryption)
- [CipherStash Proxy](/docs/proxy)
...
See [Supported Queries](/docs/concepts/supported-queries) for a complete list, implementation details and limitations.
...
CipherStash uses a strict JSON schema called a [CipherCell](/docs/concepts/cipher-cell) which is covered in the next section.
...
| Client | [CipherStash Proxy](/docs/proxy) or an app running the [Encryption SDK](/docs/encryption) |
...
- Learn about the [CipherCell](/docs/concepts/cipher-cell) storage format
- Review [supported queries](/docs/concepts/supported-queries)
- Understand the [Encrypt Query Language (EQL)](/docs/concepts/eql)
