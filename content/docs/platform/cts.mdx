...
CTS issues tokens that grant clients access to [ZeroKMS](/docs/kms).
...
A client can be either [CipherStash Proxy](/docs/proxy) or an application using the [Encryption SDK](/docs/encryption).
...
If you want to bring your own [IDP](/docs/glossary#idp-identity-provider) to CTS, you can configure your workspace to use either [Auth0](https://auth0.com/), [Okta](https://okta.com/), or [Clerk](https://clerk.com/).
...
[Access keys](/docs/platform/access-keys) are a persistent credential you can use for machine-to-machine access to CTS.
