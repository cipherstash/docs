...
See [Supported Queries](/docs/platform/supported-queries) for a complete list, implementation details and limitations.
...
CipherStash uses a strict JSON schema called a [CipherCell](/docs/platform/cipher-cell) which is covered in the next section.
...
- Learn about the [CipherCell](/docs/platform/cipher-cell) storage format
- Review [supported queries](/docs/platform/supported-queries)
- Understand the [Encrypt Query Language (EQL)](/docs/platform/eql)
