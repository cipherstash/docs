...
The `encrypt` command encrypts existing plaintext data in place. Follow the safeguards in [Data migration](/guides/migration) before running it against populated production data.
