...
<Cards>
  <Card title="Interactive setup" href="/reference/cli/init" description="Run stash init to scaffold your project and generate context.json." />
  <Card title="Draft an encryption plan" href="/reference/cli/plan" description="Run stash plan to produce a reviewable encryption plan." />
  <Card title="Execute an encryption plan" href="/reference/cli/impl" description="Run stash impl to hand off to a coding agent and execute the plan." />
</Cards>
