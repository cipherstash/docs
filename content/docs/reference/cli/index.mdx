...
title: CLI
navTitle: Overview
description: "Command reference for the stash CLI, generated from v1.0.0."
type: reference
components: [cli]
verifiedAgainst:
  cli: "1.0.0"
...
The `stash` CLI. Install with `npx stash@1.0.0`. Every command accepts `--help` and `--version`.
...
| [`eql migration`](/reference/cli/eql#eql-migration) | Generate an EQL v3 install migration for your ORM (Drizzle; Prisma Next installs EQL through its own migrations) |
