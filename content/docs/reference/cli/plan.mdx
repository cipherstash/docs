...
<Cards>
  <Card title="Execute the plan" href="/reference/cli/impl" description="Run stash impl to hand off to an agent and execute the encryption plan." />
  ...
  <Card title="Install and upgrade EQL" href="/reference/cli/install" description="Manually install or upgrade the EQL database extension." />
</Cards>
