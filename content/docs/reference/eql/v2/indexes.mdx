...
- [Searchable encryption overview](/concepts/searchable-encryption): How searchable indexes work
- [Supabase integration](/integrations/supabase): Supabase-specific setup and limitations
