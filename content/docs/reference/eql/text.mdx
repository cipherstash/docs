...
Declare only the capabilities you query on — each capability stores extra searchable material with defined leakage (see [Searchable encryption](/how-it-works/searchable-encryption)).
