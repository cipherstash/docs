...
See [Schema definition](/docs/encryption/schema) for full details on index types, data types, and nested objects.
...
See [Error handling](/docs/encryption/error-handling) for details on error codes and handling patterns.
