...
- **Want to understand it before you install it?** [Searchable encryption](/concepts/searchable-encryption) explains how encrypted queries work and what each query capability enables.
