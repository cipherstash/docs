...
## Why encrypting a column has meant losing the query
...
**You are deciding whether this is the right tool.** Start with [searchable encryption](/concepts/searchable-encryption) to understand how encrypted queries work. The [comparisons](/concepts/compare) are written to be honest about what CipherStash is not.
