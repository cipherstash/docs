...
`cipherstashFromStack` uses the local developer profile automatically. For CI or a deployed application, see [Credentials](/integrations/prisma/deployment#credentials) for the CLI and Dashboard options.
