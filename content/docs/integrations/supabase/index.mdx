...
- **[Quickstart](/integrations/supabase/quickstart):** the end-to-end walkthrough — install EQL, wrap your client, query encrypted data — plus the direct-connection path if you use Drizzle or Prisma.
