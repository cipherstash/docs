...
- **[Key management and audit logging](/security/audit-logging):** per-value keys and rotation through CipherStash ZeroKMS, a decryption access trail out of the box, and optional Bring Your Own Key.

On the [`cipherstash/benches`](https://github.com/cipherstash/benches) suite, exact-match lookups run at roughly 0.1 ms and encrypted range queries at 0.5 ms, staying flat from 10k up to 10M rows. CipherStash never sees your data or your keys, and ships with FIPS and SOC 2 compliance.
