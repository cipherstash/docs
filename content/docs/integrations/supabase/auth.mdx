...
> **Good to know**: the dashboard's [Supabase integration](/integrations/supabase#connecting-your-project-to-cipherstash) can register this for you in one click while it's connected to your project over OAuth. Manual OIDC configuration is covered in the [auth reference](/reference/auth).
