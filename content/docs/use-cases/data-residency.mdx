...
ZeroKMS is available in [multiple regions](/docs/kms/regions) globally:
...
| **Ability to revoke access** | Delete client credentials or revoke [Lock Context](/docs/encryption/identity) identities |
| **Cryptographic enforcement** | Dual-party key split makes unauthorized access mathematically impossible |

## Next steps

- [Configure ZeroKMS regions](/docs/kms/regions) for your workspaces
- [Set up identity-aware encryption](/docs/encryption/identity) for access control
- [Review disaster recovery](/docs/kms/disaster-recovery) for multi-region key backup
