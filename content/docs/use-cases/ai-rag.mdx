...
When you need to filter documents by metadata before or alongside vector search, use [searchable encryption](/docs/encryption/searchable-encryption) with EQL:
...
- **Audit trail** — track who retrieved which documents and when using [identity-aware encryption](/docs/encryption/identity)
