...
When combined with [identity-aware encryption](/docs/encryption/identity), the events are also linked to client identity, providing an end-to-end view of data access.
