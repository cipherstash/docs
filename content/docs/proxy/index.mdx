...
- **Uses [ZeroKMS](/docs/kms)**, offering up to 14x the performance of AWS KMS
- **Runs in a container** or as a standalone CLI tool

Behind the scenes, CipherStash Proxy uses the [Encrypt Query Language (EQL)](/docs/platform/eql) to index and search encrypted data.
...
<Cards>
  <Card title="Getting started" href="/docs/proxy/getting-started" description="Get up and running in local dev in under 5 minutes." />
  <Card title="Configuration" href="/docs/proxy/configuration" description="Docker setup, environment variables, and EQL installation." />
  <Card title="Deploy to AWS ECS" href="/docs/proxy/aws-ecs" description="Step-by-step guide for deploying Proxy to AWS ECS." />
</Cards>
